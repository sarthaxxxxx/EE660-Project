...
def mutli_class_sentence_transfoemr(data_sp):

  print("""### Multi Class using Sentence Transformer""")
  ...
  X_under, y_under = undersample.fit_resample(data_s[['cleanText']], data_s['Character'])
